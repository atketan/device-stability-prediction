...
Positional stability prediction for a Gyroscope incorporated device using Machine Learning. Given a real time gyroscopic data (which consists of noises as well), machine learning model is expected to predict whether the device is stable or moving.
